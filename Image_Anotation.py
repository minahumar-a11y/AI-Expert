...
# Step 5: Add Level Labels for Regions and Centers
...
cv2.putText(image_rgb, 'H: {}px'.format(height), height_label_position, font, 0.8, (255, 255, 0), 2, cv2.LINE_AA)
